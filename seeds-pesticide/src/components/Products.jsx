...
const ProductPage = () => {
    const { id } = useParams(); // category is no longer needed, we fetch by ID
    ...
    if (loading) {
        return <h3 className="text-center text-muted my-5">Loading product...</h3>;
    }
    ...
    const handleAddToCart = () => {
        // later: add product to cart
        navigate("/cart");
    };

    const handleBuyNow = () => {
        // later: pass product to checkout
    ...
    return (
        <div className="container py-5" style={{ minHeight: "100vh" }}>
            <div className="card shadow-lg p-4 border-0">
                ...
                {/* Customer Reviews (future: from DB table/collection) */}
